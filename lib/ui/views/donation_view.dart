  ...
  void _processPayment() async {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        icon: const Icon(Icons.check_circle, color: Color(0xFF0070BA), size: 60),
        title: const Text('Confirmación de Envío'),
        content: Text('Has donado exitosamente $_monto $_monedaSeleccionada a la Biblioteca Unimet.'),
        actions: [
          TextButton(
            onPressed: () {
      ...
      child: Column(
        children: [
          const CircleAvatar(
            ...
            child: Icon(Icons.account_balance, color: Color(0xFF003087), size: 30),
          ),
          const SizedBox(height: 15),
          const Text('Donar a Biblioteca Unimet', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          ...
          Container(
            ...
            child: Column(
              children: [
                const Text('Monto de la donación', style: TextStyle(color: Colors.grey)),
          ...
          const Align(
            ...
            child: Text('Pagar con', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
          ),
          const SizedBox(height: 10),
          Container(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text('Tarjeta de crédito principal', style: TextStyle(fontSize: 12, color: Colors.grey)),
                  ],
                ),
                Spacer(),
          ...
          const SizedBox(height: 15),
          const Text('Transacción protegida por PayPal', style: TextStyle(fontSize: 12, color: Colors.grey)),
        ],
      ),
    );
  }
    ...
    return const Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          Text('Conectando con PayPal...', style: TextStyle(fontWeight: FontWeight.w500)),
        ],
      ),
    );
  }
